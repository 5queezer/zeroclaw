...
Hrafn's architecture is trait-driven and modular.
...
Channels let Hrafn communicate through any messaging platform.
...
Providers are LLM backend adapters. Each provider connects Hrafn to a different model API.
