# Hrafn PR Workflow (High-Volume Collaboration)

This document defines how Hrafn handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Hrafn/project-native labels.
...
- Confirm any required identity-like wording uses Hrafn/project-native terminology.
