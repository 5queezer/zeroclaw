...
This guide covers setting up browser automation capabilities in Hrafn, including both headless automation and GUI access via VNC.

## Overview

Hrafn supports multiple browser access methods:
...
```bash
echo "Open https://example.com and tell me what it says" | hrafn agent
```
...
### Hrafn Integration Tests

```bash
# Content extraction
echo "Open https://example.com and summarize it" | hrafn agent

# Navigation
echo "Go to https://github.com/trending and list the top 3 repos" | hrafn agent

# Form interaction
echo "Go to Wikipedia, search for 'Rust programming language', and summarize" | hrafn agent
```
...
- [Hrafn Configuration Reference](./config-reference.md)
