...
Hrafn provides prebuilt binaries for Android devices.
...
The easiest way to run Hrafn on Android is via [Termux](https://termux.dev/).
...
For advanced users who want to run Hrafn outside Termux:
