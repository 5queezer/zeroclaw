...
| Hardware | RAM | Hrafn (base) | Hrafn (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, Hrafn uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### Hrafn's Core Promise: Swap Anything
