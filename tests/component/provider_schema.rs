...
use hrafn::providers::compatible::AuthStyle;
use hrafn::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use hrafn::providers::compatible::OpenAiCompatibleProvider;
