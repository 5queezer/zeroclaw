//! # Hrafn Robot Kit
//!
//! A standalone robotics toolkit that integrates with Hrafn for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  Hrafn AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use hrafn_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of Hrafn. It defines its own
//! `Tool` trait that is compatible with Hrafn's but doesn't require it.
//!
//! ## Safety
//!
