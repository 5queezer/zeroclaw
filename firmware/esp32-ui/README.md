# Hrafn ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Hrafn edge scenarios on ESP32.
...
3. Connect UI state with Hrafn edge/runtime messaging
...
- [Hrafn Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
