//! Hrafn Nucleo-F401RE firmware — JSON-over-serial peripheral.
//!
...
use heapless::String;
use hrafn_fw_protocol::{copy_id, write_err, write_ok, Command};
...
async fn main(_spawner: Spawner) {
    ...
    info!("Hrafn Nucleo firmware ready on USART2 (115200)");
