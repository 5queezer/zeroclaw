//! Plugin manifest — `~/.hrafn/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how Hrafn spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, Hrafn will prefer the named transport kind
