...
const SNAPSHOT_HEADER: &str = "# 🧠 Hrafn Memory Snapshot\n\n\
    > Auto-generated by Hrafn. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Hrafn Memory Snapshot

> Auto-generated by Hrafn.
...
I am Hrafn, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Hrafn Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
