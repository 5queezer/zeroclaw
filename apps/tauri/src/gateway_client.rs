//! HTTP client for communicating with the Hrafn gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://hrafn.example.com:9999", None);
        assert_eq!(client.base_url, "https://hrafn.example.com:9999");
    }
